		...
		stage('Check DiagramConverter build succeeded'){
			steps{
				script{
					...
					def diagramUrl = httpRequest authentication: 'jenkinsKey', validResponseCodes: "${env.VALID_RESPONSE_CODES}", url: "${env.JENKINS_JOB_URL}/job/$currentRelease/job/GenerateGraphDatabaseAndAnalysisCore/lastBuild/api/json"
