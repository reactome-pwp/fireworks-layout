...
public abstract class AbstractMenuDialog extends DialogBox implements ClickHandler {
    ...
    public void clear() {
        ...
        this.container.add(new ControlButton("Close", RESOURCES.getCSS().close(), this));
    }
    ...
    public interface ResourceCSS extends CssResource {
         ...
         */
        String CSS = "org/reactome/web/fireworks/controls/top/common/AbstractMenuDialog.css";
