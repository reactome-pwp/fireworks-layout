...
public class FacetTag extends FocusPanel {
    ...
    private void init() {
        ...
        Image image = new Image(ImageResolver.getImage(name));
     ...
     */
    @CssResource.ImportedWithPrefix("fireworks-FacetTagCSS")
    public interface FacetTagCSS extends CssResource {
        /**
         * The path to the default CSS styles used by this resource.
         */
        String CSS = "org/reactome/web/fireworks/search/searchonfire/facets/FacetTag.css";
