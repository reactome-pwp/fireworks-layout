package org.reactome.web.fireworks.controls.top.menu.submenu;
...
public class AboutDialog extends DialogBox {
    ...
    private void setTitlePanel() {
        ...
        InlineLabel title = new InlineLabel("About Pathways Overview");
        fp.add(title);
    ...
    @CssResource.ImportedWithPrefix("fireworks-AboutDialog")
