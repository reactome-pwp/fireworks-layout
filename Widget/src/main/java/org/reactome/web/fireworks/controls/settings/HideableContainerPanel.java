...
import org.reactome.web.fireworks.controls.settings.tabs.AboutTabPanel;
import org.reactome.web.fireworks.controls.settings.tabs.ProfilesTabPanel;
...
public class HideableContainerPanel extends FlowPanel implements ClickHandler {
    ...
    public HideableContainerPanel(EventBus eventBus) {
        ...
        AboutTabPanel aboutTabPanel = new AboutTabPanel("About the Pathway Overview",RESOURCES.aboutThis());
    ...
    @CssResource.ImportedWithPrefix("fireworks-HideableContainerPanel")
    public interface ResourceCSS extends CssResource {
        String CSS = "org/reactome/web/fireworks/controls/settings/HideableContainerPanel.css";
